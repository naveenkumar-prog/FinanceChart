        ...
        >
            ...
            <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <YAxis domain={[12000, 26000]} tickLine = {false} axisLine={{ strokeWidth: '0' }} style={{ fontSize : "10px" }} tickFormatter={(v) => `₹${v}`} >
                          <Label value="Revenue in Rupees" angle={-90} offset={-5} position="insideLeft"/>
                      </YAxis>
                      <Tooltip />
