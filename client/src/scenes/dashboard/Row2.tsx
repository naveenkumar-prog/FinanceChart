...
const Row2 = () => {
  ...
  const operationalExpenses = useMemo(()=>{
      return (
        operationalData && operationalData[0].monthlyData.map(({ month, nonOperationalExpenses, operationalExpenses }) => {
          return {
  ...
  return (
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Tooltip />
          <Line yAxisId="left" type="monotone" dataKey="Non Operational Expenses" stroke={palette.secondary[500]}/>
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Scatter name="Product Expense Ratio" data={productExpenseData} fill={palette.secondary[500]} />
        </ScatterChart>
      </ResponsiveContainer>
    </DashboardBox>
    </>
