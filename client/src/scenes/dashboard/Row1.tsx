...
import { ResponsiveContainer, AreaChart, Area, XAxis,YAxis,Tooltip, Line, CartesianGrid, Legend, LineChart, Bar, BarChart, Rectangle} from 'recharts';
  ...
  return (
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Line yAxisId="left" type="monotone" dataKey="profit" stroke={palette.secondary[500]}/>
